...
namespace BuilderAssignment
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var misoRamen = chef.PrepareRamen(misoRamenBuilder);
            var spicyRamen = chef.PrepareRamen(spicyRamenBuilder);
            var veganRamen = chef.PrepareRamen(veganRamenBuilder);
            ...
            Console.WriteLine("Miso Ramen: " + misoRamen.FinishedBowlOfRamen());
            Console.WriteLine("Spicy Ramen: " + spicyRamen.FinishedBowlOfRamen());
            Console.WriteLine("Vegan Ramen: " + veganRamen.FinishedBowlOfRamen());
        }
    }
}